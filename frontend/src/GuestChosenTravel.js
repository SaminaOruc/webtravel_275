    ...
    return(
        <div className="d-flex justify-content-center align-items-center bg-warning">
            <div className="bg-white p-3 rounded w-80 m-5">
                <Link to={"/guest-home"} className="btn btn-default border w-100 bg-light text-decoration-none">Go Back</Link>
...
export default GuestChosenTravel;